...
An example of a vague prompt is: "create an app"
The improved prompt is " Assuming the role of a software engineer, design a mobile budgeting app usithat allows users to track their expenses, set savings goals, and visualize spending trends through graphs."
