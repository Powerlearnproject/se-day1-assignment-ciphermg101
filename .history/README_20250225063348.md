...
The improved prompt is "Design a mobile budgeting app that allows users to track their expenses, set savings goals, and visualize spending trends through graphs."
