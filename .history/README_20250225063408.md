...
The improved prompt is " Assuming the role of a software engineer, design a mobile budgeting app that allows users to track their expenses, set savings goals, and visualize spending trends through graphs."
